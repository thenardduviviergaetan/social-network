...
import Notifications, { EventNotifications, GroupNotifications, InviteNotifications } from "@/app/ui/dashboard/notifications";
...
export default async function SideNav() {
  ...
  return (
    <div className="flex flex-col px-3 py-4 md:px-2">
      ...
      <EventNotifications user={session?.user?.uuid} />
    </div>
  );
}
